...
# Repositories URLs
wazuh_app_clone_repo_url="https://github.com/rbkmoney/wazuh-kibana-app.git"
wazuh_app_raw_repo_url="https://raw.githubusercontent.com/rbkmoney/wazuh-kibana-app"
